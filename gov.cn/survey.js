...
(async () => {
  ...
  try {
    ...
    print(survey, survey.length);

    await page.goto(survey[1].href);
    ...
    const content = await page.evaluate(async () => {
      return document.querySelector('#UCAP-CONTENT > div.view.TRS_UEDITOR.trs_paper_default.trs_web > p:nth-child(7)').innerHTML;
    });
