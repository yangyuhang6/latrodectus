...
(async () => {
  ...
  try {
    ...
    const targetId = '.infolist.dot.radius.fz22';
    await page.goto('https://www.gov.cn/toutiao/');
    ...
    const toutiao = await page.evaluate(async () => {
    ...
    print(toutiao, toutiao.length);

    await page.goto(toutiao[1].href);
