  ...
  try {
    ...
    const data = await page.evaluate(async () => {
      ...
      document.querySelectorAll('.zixun-list > div').forEach((el, idx) => {
        ...
        list[idx].time = el.querySelector('.zixun-item-footer span').innerHTML.trim();
        list[idx].type = el.querySelector('.zixun-item-footer span:last-child .hover-mbs a').innerHTML.trim();
      });
