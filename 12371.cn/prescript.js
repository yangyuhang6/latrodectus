...
(async () => {
  ...
  try {
    ...
    const targetClass = '.ELMT1655861784026587';
    await page.goto('https://www.12371.cn/special/dnfg/tl/');
    ...
    print(prescriptDetail, prescriptDetail.length);
  } catch (e) {
    print(e.message);
  }
