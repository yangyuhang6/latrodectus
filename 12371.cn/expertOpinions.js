...
(async () => {
  ...
  try {
    ...
    const tagetClass = '.ELMT1614757865419858';
    ...
    while (true) {
      ...
      expertOpinionsDetail.push(...detail);

      if (await page.$('#fenye0ELMT1614757865419858 .tpb_btn_previous:nth-last-child(2)') === null) break;
      await page.click('#fenye0ELMT1614757865419858 .tpb_btn_previous:nth-last-child(2)');
      await page.waitForSelector('.dyw5210_three_listtext', {
        timeout: 5000,
      });
    }

    print(expertOpinionsDetail, expertOpinionsDetail.length);
  } catch (e) {
    print(e.mesage);
  }
