...
(async () => {
  ...
  try {
    ...
    const targetClass = '.ELMT1655861760768307';
    await page.goto('https://www.12371.cn/special/dnfg/xz/');
    ...
    print(detailedRules, detailedRules.length, detailedRules[1].text);
  } catch (e) {
    print(e.message);
  }
