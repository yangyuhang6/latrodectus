...
(async () => {
  ...
  try {
    ...
    const targetClass = '.ELMT1655861778313517';
    await page.goto('https://www.12371.cn/special/dnfg/gd/');
    ...
    print(stipulationDetail, stipulationDetail.length);
  } catch (e) {
    print(e.message);
  }
