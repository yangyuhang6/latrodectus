...
(async () => {
  ...
  try {
    ...
    const targetClass = '.ELMT1617875313379707';
    await page.goto('https://www.12371.cn/dsxx/xds/');
    ...
    const gloriousPastDetail = await page.evaluate(async () => {
    ...
    print(gloriousPastDetail, gloriousPastDetail.length);
  } catch (e) {
    print(e.message);
  }
