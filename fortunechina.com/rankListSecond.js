...
(async () => {
  ...
  try {
    ...
    await page.goto(rankList[11].href);

    await page.waitForSelector('.hf-content', {
      timeout: 5000,
    });

    const content = await page.evaluate(async () => {
      return document.querySelector('body > div.main > div > div.hf-content > div > div.hf-left > p:nth-child(6)').innerHTML;
    });
