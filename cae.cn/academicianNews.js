...
(async () => {
  ...
  try {
    ...
    const introduce = await page.evaluate(async () => {
      return document.querySelector('body > div.news_detail_main > div.news_detail_content > div.news_detail_left > div.news_detail_text > p:nth-child(8) > span').innerHTML;
    });
