...
(async () => {
  ...
  try {
    ...
    const targetId = '.rmbs_a.rmbs_b';
    await page.goto('https://casad.cas.cn/ysxx2022/ygwj/');
    ...
    await page.goto(lateAcademician[11].href);
    ...
    const introduce = await page.evaluate(async () => {
      return document.querySelector('#zoom > div.acadTxt > div:nth-child(2)').innerHTML;
    });
